...
QBConfig.Player = {}
QBConfig.Player.HungerRate = 0   -- DESATIVADO: Fome não diminui mais
QBConfig.Player.ThirstRate = 0   -- DESATIVADO: Sede não diminui mais
QBConfig.Player.DisableHungerThirst = true -- Flag global para desativar fome/sede
